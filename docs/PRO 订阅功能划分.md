...
### ✅ D-2：AI 标签 / 摘要试用次数 — **已拍板 2026-06-18**

> 决策：**各 3 次**，按 GitHub User ID + 本机持久化记录。详见 `docs/StoreKit订阅上架方案.md` §2。

~~选项 B（10 次）~~、~~选项 C（0 次硬墙）~~ — 未采用。
...
### ✅ D-4：BYOK 用户是否仍需 Pro 订阅 — **已拍板 2026-06-18**

> 决策：**需要 Pro**；配置 UI 可见，但 AI 调用需 Pro 或试用配额。
