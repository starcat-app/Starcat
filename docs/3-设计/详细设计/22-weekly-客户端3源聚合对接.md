...
> **2026-07-15 后续方案**：本文只保留 R-05 三源客户端落地的历史设计。动态来源目录、通用 `source_entries`、HelloGitHub/AI 情报图标、本地缓存 migration 与置顶排序统一以 [`Weekly 多来源扩展、AI 情报采集与置顶运营正式方案`](../../2-产品/需求讨论/正式方案/Weekly多来源扩展与AI情报采集正式方案.md) 为准。
