...
> 决策（2026-06-18）：**路径 B** — v1 接入 StoreKit（月订 + 年订），CloudKit 延后且后续归 Pro。实施规格见 **`docs/2-产品/需求讨论/正式方案/StoreKit订阅上架方案.md`**。
> Direct 渠道（2026-06-27）：官网 DMG + Lemon Squeezy 授权码方案已落档，见 **`docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md`**；App Store build 不展示授权码 / Lemon Squeezy / 外部购买入口。
...
| **首版即收费** | ✅ 已选路径 B 且客户端已落地；见 `docs/2-产品/需求讨论/正式方案/StoreKit订阅上架方案.md`（月订+年订，买断 v0.2） |
...
| `docs/2-产品/需求讨论/正式方案/StoreKit订阅上架方案.md` | **v1 StoreKit 实施单一信任源**（路径 B、SKU、门控、Connect 工作流） |
| `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md` | 官网 DMG + Lemon Squeezy 授权码的 Direct 渠道方案 |
...
| 2026-06-18 | §3.2 对齐路径 B 拍板；链入 `docs/2-产品/需求讨论/正式方案/StoreKit订阅上架方案.md`；D-1 勾选 |
...
| 2026-06-27 | 补充 Direct 渠道口径：官网 DMG 版走 Lemon Squeezy 授权码，App Store build 保持 StoreKit-only；链入 `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md`。 |
