...
> 拆 commit count 与 hash 是为了一次性满足 App Store 规范（详见 `docs/工程进度/功能实现总览.md` 2026-06-07 14:50 条）。
...
- [ ] **`docs/工程进度/功能实现总览.md`** —— 顶部「最近更新」+「变更日志」追加发版条目（参考已有格式）
...
| 实现历史 | `docs/工程进度/功能实现总览.md` 变更日志 2026-06-07 14:35 / 14:50 / 15:00 / 15:10 四条 |
