...
> 前置阅读：`docs/2-产品/需求讨论/正式方案/PRO 订阅功能划分.md`、`docs/6-发版与上架/v1-上架检查清单.md`、`docs/2-产品/需求讨论/正式方案/CloudKit数据同步设计.md`
> 合规页面：`pages/privacy.html`、`pages/privacy-zh.html`、`pages/eula.html`、`pages/eula-zh.html`
> Direct 渠道：官网 DMG + Lemon Squeezy 授权码见 `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md`
...
> 原 `docs/2-产品/需求讨论/正式方案/PRO 订阅功能划分.md` §8 待决策项，本节为 dong4j 确认后的**生效版本**。
...
依据 `docs/2-产品/需求讨论/正式方案/CloudKit数据同步设计.md` + D-30 多账号隔离：
...
| Direct 授权与 App Store 审核边界混淆 | App Store build 不展示 Lemon Squeezy、license key 或外部购买入口；Direct build 单独走 `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md` |
...
1. `docs/功能实现总览.md` §5.3 勾选 + `> 实现：...`
2. `docs/2-产品/需求讨论/正式方案/PRO 订阅功能划分.md` 状态改为「已拍板」并链本文档
3. `docs/6-发版与上架/v1-上架检查清单.md` §3.2 更新 StoreKit 进度
4. `docs/1-立项/功能清单.md` §7 定价章节（可选，与 PRO 文档对齐）
...
| 文档 | 关系 |
|------|------|
| `docs/2-产品/需求讨论/正式方案/Pro付费墙验证清单.md` | 免费用户触发 Pro 能力 → 付费墙的人工验收走查清单 |
| `docs/6-发版与上架/SOP-App-Store-Connect-Offer-Code.md` | Connect 创建订阅 Offer Code + App 内兑换 SOP |
| `docs/2-产品/需求讨论/正式方案/PRO 订阅功能划分.md` | 功能级免费/Pro 详单；§8 已由本文 §2 覆盖 |
| `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md` | 官网 DMG 分发、Lemon Squeezy license 与 Direct build 授权边界 |
| `docs/6-发版与上架/v1-上架检查清单.md` | 上架走查；路径 B 已选 |
| `docs/2-产品/需求讨论/正式方案/CloudKit数据同步设计.md` | CloudKit 技术设计；v1 不实施，D-1=Pro |
| `docs/6-发版与上架/SOP-发版流程.md` | tag / DMG / 提审节奏 |
...
| 2026-06-27 | 补充渠道边界：本文限定为 App Store / StoreKit 单一信任源；官网 DMG + Lemon Squeezy 授权码独立见 `docs/2-产品/需求讨论/正式方案/Direct分发与LemonSqueezy授权方案.md`。 |
