...
>
> 状态：**§8 核心项已拍板（2026-06-18）**；支付实施规格以 **`docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`** 为单一信任源。
>
> 前置阅读：`docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`（App Store / Direct 支付方案）、`docs/1-立项/功能清单.md` §7、`docs/1-立项/需求分析.md` §7。
...
> 决策：**归 Pro**；**v1 首版不实现 CloudKit**。详见 `docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`。
...
> 决策：**0 次，免费版零 AI**。详见 `docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`。
...
> 拍板结果见 **`docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`**。以下为功能边界参考；支付代码实施需 dong4j 明确「开干」后启动。
...
- `docs/2-产品/需求讨论/正式方案/支付对接正式方案.md`（**StoreKit + Direct provider-neutral 支付方案，优先阅读**）
