...
> ⚠️ **已过时（2026-08-04）**：本文保留 2026-06 的 Agent 方向讨论、生态调研与候选场景，仅用于历史追溯，不再作为开发依据。当前权威方案见 [`../../../3-设计/详细设计/57-Agent工作台与统一能力层详细设计.md`](../../../3-设计/详细设计/57-Agent工作台与统一能力层详细设计.md)。若本文与新版方案、当前 RAG/MCP/CLI 实现冲突，以新版方案和现行代码为准。

> **文档定位**: 总览索引,记录 2026-06-27 与 dong4j 讨论的 Starcat Agent 化方向、生态调研、候选场景与决策点。
> **状态**: 已过时；仅保留为历史讨论稿，当前开发以 57 新版方案为准。
> **关联文档**:
