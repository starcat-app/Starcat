...
- [x] RAG Planner 拆分 `semanticQuery` 与目标 3～8 个双语 `keywordQueries`，FTS5 使用安全 OR，普通搜索 AND 保持不变 — `KnowledgeRAGQueryPlanner.swift`、`RAGSearchProviders.swift` — 2026-07-17
