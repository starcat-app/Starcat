...
- 洞察代码基线 `8758495a` 的 Starcat / StarcatDirect Debug build 通过。
- 同一基线全量 `2051` 项：`2042` 通过、`8` 跳过、`1` 个预期失败、`0` 个非预期失败。
...
- 后续小组件合并未修改洞察 / RAG 文件；当前全量门禁被小组件 provisioning profile 阻断，详见 [`关单报告.md`](关单报告.md)。
