...
> 前置阅读：`docs/StoreKit订阅上架方案.md`、`docs/Pro付费墙验证清单.md`
...
| **与 Promotional Offer 区别** | Offer Code = 发字符串码、App 外也可兑、**无需**服务器签名；见 `docs/StoreKit订阅上架方案.md` 讨论 |
...
完整 Pro 门控验收见 `docs/Pro付费墙验证清单.md`。
...
| 文档 | 关系 |
|------|------|
| `docs/StoreKit订阅上架方案.md` | v1 SKU、Intro 试用、门控总览 |
| `docs/Pro付费墙验证清单.md` | Pro 功能人工验收 |
| `docs/StoreKit订阅实施决策记录.md` | 为何 v1 不做 Server API 验签 |
