...
- 对 dong4j 友好：每次引入新的 SwiftUI / AppKit 概念，要在 `docs/7-工具与脚本/Swift-学习索引.md` 补关键词和项目位置。
...
引入依赖前先查 `docs/3-设计/详细设计/04-技术选型.md`，并在 `docs/7-工具与脚本/第三方资源使用记录.md` 记录用途、许可证和替代方案。
...
- [ ] 是否避免大列表 move 动画？
- [ ] 是否需要补 `docs/7-工具与脚本/Swift-学习索引.md`？
- [ ] 是否更新 `docs/功能实现总览.md`？
...
后续实现 Phase 1 时，优先补充这些关键词到 `docs/7-工具与脚本/Swift-学习索引.md`：
