...
struct CompanionRequestParserTests {
    ...
    func parsesRequest() throws {
        ...
        #expect(request.path == "/plugin/v1/repo-context")
    ...
    func rejectsDuplicateQueryKey() throws {
        let raw = "GET /plugin/v1/repo-context?owner=apple&owner=swift HTTP/1.1\r\n\r\n"
    ...
    func rejectsLargeBody() throws {
        var data = Data("POST /plugin/v1/notes HTTP/1.1\r\n\r\n".utf8)
