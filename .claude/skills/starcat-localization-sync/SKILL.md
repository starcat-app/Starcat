...
description: Starcat 本地化同步与 String Catalog 维护流程。用于用户要导出或导入 supports/starcat-localization 的 xcloc 语言包、同步 Localizable.xcstrings、批量修补 xcstrings key/value、审计 i18n 规则、处理 en 和 zh-Hans 双语、或询问 supports/scripts/starcat-localization.py 与 scripts/xcstrings_patch.py 如何使用的场景。
---
