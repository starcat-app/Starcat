...
echo "defaults write com.starcat.app.direct.debug DebugDeepSeekHarnessProvider -string deepseek-official"
echo "defaults write com.starcat.app.direct.debug DebugDeepSeekHarnessModel -string deepseek-v4-flash"
