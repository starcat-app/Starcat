...
- https://github.com/dong4j/Starcat
...
- **GitHub repo**: https://github.com/dong4j/Starcat
...
1. Run `multica issue get 5c6ec3a4-61a1-413a-ab13-d2adf5f224ca --output json` to understand the issue context
2. Run `multica issue metadata list 5c6ec3a4-61a1-413a-ab13-d2adf5f224ca --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the triggering comment ID / thread anchor: `19901bfc-9f3e-4124-9657-a5cadce2fc8f`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list 5c6ec3a4-61a1-413a-ab13-d2adf5f224ca --thread 19901bfc-9f3e-4124-9657-a5cadce2fc8f --tail 30 --output json`.

4. Find the triggering comment (ID: `19901bfc-9f3e-4124-9657-a5cadce2fc8f`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    cat <<'COMMENT' | multica issue comment add 5c6ec3a4-61a1-413a-ab13-d2adf5f224ca --parent 19901bfc-9f3e-4124-9657-a5cadce2fc8f --content-stdin
    First paragraph.
