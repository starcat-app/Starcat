//
//  AgentWorkspaceRunSurface.swift
//  Starcat
//
//  Agent 工作台中栏的稳定渲染边界。
//
//  左侧 Sidebar 的折叠动画会连续改变 NavigationSplitView 的列宽。中栏必须独立持有
//  Composer 与 Runtime 选择状态，避免根视图的几何变化重新构建输入框和模型菜单。
//
...
struct AgentWorkspaceRunSurface: View {
    ...
    @Bindable var viewModel: AgentWorkspaceViewModel
